...
| Auth                  | Yes      | Yes        | Partial  | Partial  | No               | Invite links, accept page, login, logout, `me`, reset page, session revocation, login attempts, security events, and audit paths are integrated.                            |
