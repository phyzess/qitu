...
| --------------------- | -------- | ---------- | -------- | -------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| React app shell       | Yes      | Yes        | Yes      | Partial  | No               | API-backed login, protected routes, account/logout, persisted English/Simplified Chinese language selection, user management entry, source/import/review/audit pages, role-aware write controls, source/job diagnostics, import-to-review selection memory, and scripted browser smoke coverage. |
