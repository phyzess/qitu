...
| ------------ | ----------------------------------- | --------------------------------------------------------- | --------- |
| AlertDialog  | `packages/ui/src/alert-dialog.tsx`  | shadcn Base UI registry over `@base-ui/react/dialog`      | Compliant |
...
| Calendar     | `packages/ui/src/calendar.tsx`      | shadcn calendar over `react-day-picker`                   | Compliant |
...
| Command      | `packages/ui/src/command.tsx`       | shadcn registry over `cmdk`                               | Compliant |
| Dialog       | `packages/ui/src/dialog.tsx`        | shadcn Base UI registry over `@base-ui/react/dialog`      | Compliant |
| Drawer       | `packages/ui/src/drawer.tsx`        | shadcn registry over `vaul`                               | Compliant |
| DropdownMenu | `packages/ui/src/dropdown-menu.tsx` | shadcn Base UI registry over `@base-ui/react/menu`        | Compliant |
| Input        | `packages/ui/src/input.tsx`         | shadcn Base UI registry over `@base-ui/react/input`       | Compliant |
| InputGroup   | `packages/ui/src/input-group.tsx`   | shadcn registry composition                               | Compliant |
...
| Select       | `packages/ui/src/select.tsx`        | shadcn Base UI registry over `@base-ui/react/select`      | Compliant |
...
| Table        | `packages/ui/src/table.tsx`         | shadcn registry table pattern                             | Compliant |
...
| UploadQueue          | `packages/ui/src/upload-queue.tsx`           | qitu file queue composition               | Compliant |

## Qitu-Specific Primitives

| Primitive                                 | File                                | Reason                                         | Status    |
| ----------------------------------------- | ----------------------------------- | ---------------------------------------------- | --------- |
| AnimatedIcon                              | `packages/ui/src/animated-icon.tsx` | Small semantic icon registry for shell chrome  | Compliant |
