...
| Email                 | Yes      | Partial    | Partial  | Partial  | No               | Invitation/reset templates, local delivery metadata, Cloudflare `send_email`, React token landing pages, and a business-neutral inbound email handler that stores raw RFC822 messages and hands attachments to source-file import jobs are wired.                                                                                                                 |
