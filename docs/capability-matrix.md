...
| Cloudflare deployment | Yes      | Partial    | Partial  | Partial  | No               | Local, preview, and production binding stubs exist; dry-run preflight checks public origins, Email Sending config, D1 placeholders, static assets, and queue DLQ; DLQ remediation, email deliverability, and deployment runbooks are wired, but no real account is provisioned.                                                                                   |
